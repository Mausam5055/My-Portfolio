        ...
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent">
          ...
          >
            ...
            >
              {/* Form Header */}
              <div className="mb-6">
                <h3 className="text-xl md:text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Send a Message</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">Fill out the form below and I'll get back to you as soon as possible.</p>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-center space-x-4 p-3 bg-gray-50 dark:bg-gray-800/50 rounded-lg">
                  <span className="text-sm text-gray-600 dark:text-gray-400 font-medium">{captcha.question}</span>
                  <motion.input
                    whileFocus={{ scale: 1.01 }}
                    type="text"
                    id="captcha"
