...
const projects = [
  {
    ...
    contributors: [{ name: "Mausam", profilePic: "/assets/mausam.jpeg" }],
  ...
  },
  {
    ...
    description:
      "Showcasing my expertise in web dev., this portfolio highlights my creativity, skills, and dedication to delivering impactful solutions.",
    ...
    contributors: [{ name: "Mausam", profilePic: "/assets/mausam.jpeg" }],
    github:
      "https://github.com/Mausam5055/My-Portfolio-1/tree/main/Protfolio-1/My-Portfolio-main",
  ...
  },
  {
    ...
    description:
      "Welcome to my first portfolio, a showcase of my creativity, skills, and dedication in Web Dev. This collection highlights my journey, passion, and commitment to delivering impactful solutions.",
